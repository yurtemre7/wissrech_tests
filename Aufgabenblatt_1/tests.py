...
class Tests(unittest.TestCase):
    ...
    def test_matrix_multiplication(self):
        ...
        self.assertTrue(np.allclose(np.dot(c, c), matrix_multiplication(c, c)))
        self.assertTrue(np.allclose(np.dot(a, b), matrix_multiplication(a, b)))
        self.assertTrue(np.allclose(np.dot(b, c), matrix_multiplication(b, c)))
